...
const DEFAULT_TRICIA = ["I think I fell head over heels for snake jazz.", "Snake jazz is like the soundtrack of my life.", "Summer, your playlist is so supes shook.", "We should totally start a vibe club.", "Why does no one appreciate snake jazz like I do?", "Ugh, math class is so not my vibe.", "I swear Jerryâ€™s bees are, like, goal energy.", "Is it weird that I think bees are aesthetic?", "Summer, letâ€™s hit the mall after school.", "Morty, donâ€™t trip on the halls.", "Your sweater is a whole mood.", "I could nap under those lockers forever.", "This cafeteria pizza is totally peak chaos.", "Letâ€™s form a band called The Vibe Travelers.", "Principal is watching us like weâ€™re some kind of documentary.", "Summer, you gotta teach me that look.", "I love deep-space fashion trends.", "Why is everyone obsessed with that alien smoothie?", "Letâ€™s make epic our middle name.", "My hair looks terrifyingly amazing today."];
